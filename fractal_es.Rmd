...
Si hacemos este proceso **iterativamente** -sacando el 1% mas grande, y a ese resultado se le vuelve a sacar el 1%, y asi sucesivamente por un total de 10 veces- estaremos analizando distintos valores de punto. Sucede algo curioso con el resultado, **la silutea se mantiene siempre parecida** a:
